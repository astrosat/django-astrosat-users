...
ASTROSAT_USERS_REQUIRE_VERIFICATION = getattr(
    settings, "ASTROSAT_USERS_REQUIRE_VERIFICATION",
    DynamicSetting(
...
ASTROSAT_USERS_REQUIRE_APPROVAL = getattr(
    settings, "ASTROSAT_USERS_REQUIRE_APPROVAL",
    DynamicSetting(
...
ASTROSAT_USERS_ALLOW_REGISTRATION = getattr(
    settings, "ASTROSAT_USERS_ALLOW_REGISTRATION",
    DynamicSetting(
...
ASTROSAT_USERS_ENABLE_BACKEND_ACCESS = getattr(
    settings, "ASTROSAT_USERS_ENABLE_BACKEND_ACCESS",
    DynamicSetting(
